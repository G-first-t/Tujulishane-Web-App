...
resource "aws_db_instance" "default" {
  ...
  identifier             = "mydb"               # matches POSTGRES_DB and your DB name
  db_name                = "mydb"               # matches POSTGRES_DB
  username               = "myuser"             # matches POSTGRES_USER
  password               = var.db_password      # keep as variable, set securely
